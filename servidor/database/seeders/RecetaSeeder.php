...
class RecetaSeeder extends Seeder
{
    public function run(): void
    {
        $PolloALaPlancha = DB::table('recetas')->insertGetId([
            ...
            'imagen'        => 'http://35.172.64.180:8000/storage/recetas/Pollo_a_la_plancha.png',
        ...
        $TortillaPatatas = DB::table('recetas')->insertGetId([
            ...
            'imagen'        => 'http://35.172.64.180:8000/storage/recetas/Tortilla_de_patatas.png',
        ...
        $SalmonAlHorno = DB::table('recetas')->insertGetId([
            ...
            'imagen'        => 'http://35.172.64.180:8000/storage/recetas/Salmon_al_horno.png',
        ...
        $Gazpacho = DB::table('recetas')->insertGetId([
            ...
            'imagen'        => 'http://35.172.64.180:8000/storage/recetas/Gazpacho.png',
        ...
        $PaellaMixta = DB::table('recetas')->insertGetId([
            ...
            'imagen'        => 'http://35.172.64.180:8000/storage/recetas/Paella_mixta.png',
        ...
        $SpaghettiBolo = DB::table('recetas')->insertGetId([
            ...
            'imagen'        => 'http://35.172.64.180:8000/storage/recetas/Spaghetti_Bolognese.png',
        ...
        $SmoothieFrutas = DB::table('recetas')->insertGetId([
            ...
            'imagen'        => 'http://35.172.64.180:8000/storage/recetas/Smoothie_de_frutas.png',
        ...
        $HamburguesaVegana = DB::table('recetas')->insertGetId([
            ...
            'imagen'        => 'http://35.172.64.180:8000/storage/recetas/Hamburguesa_vegana.png',
        ...
        $ArrozConLeche = DB::table('recetas')->insertGetId([
            ...
            'imagen'        => 'http://35.172.64.180:8000/storage/recetas/Arroz_con_leche.png',
        ...
        $SandwichMixto = DB::table('recetas')->insertGetId([
            ...
            'imagen'        => 'http://35.172.64.180:8000/storage/recetas/Sandwich_mixto.png',
        ...
        $YogurGranola = DB::table('recetas')->insertGetId([
            ...
            'imagen'        => 'http://35.172.64.180:8000/storage/recetas/Yogur_con_granola.png',
        ...
        $EnsaladaFrutas = DB::table('recetas')->insertGetId([
            ...
            'imagen'        => 'http://35.172.64.180:8000/storage/recetas/Ensalada_de_frutas.png',
        ...
        $OmeletteQueso = DB::table('recetas')->insertGetId([
            ...
            'imagen'        => 'http://35.172.64.180:8000/storage/recetas/Omelette_de_queso.png',
        ...
        $SmoothieVerde = DB::table('recetas')->insertGetId([
            ...
            'imagen'        => 'http://35.172.64.180:8000/storage/recetas/Smoothie_verde.png',
